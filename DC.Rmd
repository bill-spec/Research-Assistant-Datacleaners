...
sum(data2$count[1:50])
```

```{r}
excelDC <- boston %>% mutate(Area2 = ifelse(grepl(paste(data2$Area[1:50],collapse="|"), Area), as.character(Area), 1))
...
```{r}
write.csv("C:/Users/the36/Desktop/DC/DCWithState.csv")
```
